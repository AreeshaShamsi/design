    ...
    <footer className="bg-gray-950 text-gray-400 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.08] pointer-events-none">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <g transform="translate(100, 50)">
            <rect x="0" y="10" width="40" height="50" fill="none" stroke="currentColor" strokeWidth="2" rx="2"/>
            <line x1="20" y1="10" x2="20" y2="60" stroke="currentColor" strokeWidth="2"/>
            <line x1="0" y1="30" x2="40" y2="30" stroke="currentColor" strokeWidth="1"/>
          </g>
          
          {/* Graduation cap */}
          <g transform="translate(250, 200)">
            <polygon points="30,10 10,20 30,30 50,20" fill="none" stroke="currentColor" strokeWidth="2"/>
            <line x1="30" y1="30" x2="30" y2="45" stroke="currentColor" strokeWidth="2"/>
          ...
          <g transform="translate(400, 100)">
            <rect x="15" y="0" width="10" height="50" fill="none" stroke="currentColor" strokeWidth="2"/>
            <polygon points="20,50 15,60 25,60" fill="currentColor" stroke="currentColor" strokeWidth="2"/>
          ...
          <g transform="translate(600, 180)">
            ...
            <rect x="20" y="37" width="10" height="8" fill="none" stroke="currentColor" strokeWidth="2" rx="1"/>
            <line x1="25" y1="45" x2="25" y2="50" stroke="currentColor" strokeWidth="2"/>
            <line x1="25" y1="8" x2="25" y2="13" stroke="currentColor" strokeWidth="2"/>
          </g>
          
          {/* Notebook */}
          <g transform="translate(800, 80)">
            <rect x="10" y="5" width="35" height="45" fill="none" stroke="currentColor" strokeWidth="2" rx="2"/>
            <line x1="10" y1="15" x2="45" y2="15" stroke="currentColor" strokeWidth="1"/>
            <line x1="10" y1="25" x2="45" y2="25" stroke="currentColor" strokeWidth="1"/>
            <line x1="10" y1="35" x2="45" y2="35" stroke="currentColor" strokeWidth="1"/>
          ...
          <g transform="translate(950, 220)">
            ...
            <path d="M 25 15 Q 20 10 20 5" fill="none" stroke="currentColor" strokeWidth="2"/>
            <ellipse cx="22" cy="6" rx="3" ry="2" fill="currentColor"/>
          </g>
          
          {/* Calculator */}
          <g transform="translate(1100, 120)">
            <rect x="10" y="5" width="30" height="45" fill="none" stroke="currentColor" strokeWidth="2" rx="3"/>
          ...
          <g transform="translate(200, 280)">
            ...
            <ellipse cx="25" cy="25" rx="20" ry="8" fill="none" stroke="currentColor" strokeWidth="2" transform="rotate(45 25 25)"/>
            <ellipse cx="25" cy="25" rx="20" ry="8" fill="none" stroke="currentColor" strokeWidth="2" transform="rotate(-45 25 25)"/>
          </g>
          
          {/* Certificate */}
          <g transform="translate(500, 300)">
            <rect x="5" y="10" width="40" height="30" fill="none" stroke="currentColor" strokeWidth="2" rx="2"/>
            ...
            <line x1="10" y1="27" x2="30" y2="27" stroke="currentColor" strokeWidth="1"/>
            <line x1="10" y1="33" x2="30" y2="33" stroke="currentColor" strokeWidth="1"/>
          </g>
          
          {/* Globe */}
          <g transform="translate(850, 300)">
            <circle cx="25" cy="25" r="15" fill="none" stroke="currentColor" strokeWidth="2"/>
            <ellipse cx="25" cy="25" rx="7" ry="15" fill="none" stroke="currentColor" strokeWidth="1.5"/>
            <line x1="10" y1="25" x2="40" y2="25" stroke="currentColor" strokeWidth="1.5"/>
            <path d="M 25 10 Q 30 25 25 40" fill="none" stroke="currentColor" strokeWidth="1.5"/>
          </g>
        </svg>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          {/* Main pages */}
          <div>
            <h3 className="text-white font-semibold mb-3 text-sm">Main pages</h3>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm hover:text-white transition-colors">Courses</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm hover:text-white transition-colors">Career</a></li>
              <li><a href="#" className="text-sm hover:text-white transition-colors">Instructor</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm hover:text-white transition-colors">X</a></li>
            </ul>
          </div>
        </div>
